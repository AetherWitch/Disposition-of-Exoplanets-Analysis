...
for word in confirmed:
    con=myList.count(word)
print("frequency of confirmed exoplanets: ", con)

for word in falsepos:
    fal=myList.count(word)
print("frequency of false positive exoplanets: ", fal)

for word in candidate:
    can=myList.count(word)
print("frequency of candidates: ", can)
...
width = 0.8, color = ['#ffcccc', '#ff80bf','#ff9933']) 
